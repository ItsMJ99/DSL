 ...
 * generated in the org.si package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculateSimpleInterest_QNAME = new QName("http://si.org/", "calculateSimpleInterest");
    private final static QName _CalculateSimpleInterestResponse_QNAME = new QName("http://si.org/", "calculateSimpleInterestResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.si
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://si.org/", name = "calculateSimpleInterest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://si.org/", name = "calculateSimpleInterestResponse")
