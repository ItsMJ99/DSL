 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://calculator.org/", wsdlLocation = "http://localhost:8080/CalculatorServer/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://calculator.org/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorServer/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calculator.org/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.org/", "CalculatorPort"), Calculator.class, features);
    }
