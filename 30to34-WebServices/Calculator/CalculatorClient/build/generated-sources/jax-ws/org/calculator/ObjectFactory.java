 ...
 * generated in the org.calculator package. 
...
public class ObjectFactory {
    ...
    private final static QName _Addition_QNAME = new QName("http://calculator.org/", "addition");
    private final static QName _AdditionResponse_QNAME = new QName("http://calculator.org/", "additionResponse");
    private final static QName _Division_QNAME = new QName("http://calculator.org/", "division");
    private final static QName _DivisionResponse_QNAME = new QName("http://calculator.org/", "divisionResponse");
    private final static QName _Multiplication_QNAME = new QName("http://calculator.org/", "multiplication");
    private final static QName _MultiplicationResponse_QNAME = new QName("http://calculator.org/", "multiplicationResponse");
    private final static QName _Subtraction_QNAME = new QName("http://calculator.org/", "subtraction");
    private final static QName _SubtractionResponse_QNAME = new QName("http://calculator.org/", "subtractionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.calculator
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.org/", name = "addition")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.org/", name = "additionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.org/", name = "division")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.org/", name = "divisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.org/", name = "multiplication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.org/", name = "multiplicationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.org/", name = "subtraction")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.org/", name = "subtractionResponse")
